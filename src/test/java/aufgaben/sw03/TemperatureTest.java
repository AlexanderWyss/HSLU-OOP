...
class TemperatureTest {
    ...
    void d_aggregationState_N() {
        assertEquals("solid", Temperature.kelvin(0).getAggregationState("N"));
        assertEquals("solid", Temperature.celsius(-210.2f).getAggregationState("N"));
        assertEquals("liquid", Temperature.celsius(-210.1f).getAggregationState("N"));
        assertEquals("liquid", Temperature.celsius(-196.1f).getAggregationState("N"));
        assertEquals("gaseous", Temperature.celsius(-196).getAggregationState("N"));
        assertEquals("gaseous", Temperature.celsius(15).getAggregationState("N"));
    }

    @Test
    void d_aggregationState_Hg() {
        assertEquals("solid", Temperature.kelvin(0).getAggregationState("Hg"));
        assertEquals("solid", Temperature.celsius(-38.84f).getAggregationState("Hg"));
        assertEquals("liquid", Temperature.celsius(-38.83f).getAggregationState("Hg"));
        assertEquals("liquid", Temperature.celsius(356.9f).getAggregationState("Hg"));
        assertEquals("gaseous", Temperature.celsius(357).getAggregationState("Hg"));
        assertEquals("gaseous", Temperature.celsius(500).getAggregationState("Hg"));
    }

    @Test
    void d_aggregationState_Pb() {
        assertEquals("solid", Temperature.kelvin(0).getAggregationState("Pb"));
        assertEquals("solid", Temperature.celsius(327.42f).getAggregationState("Pb"));
        assertEquals("liquid", Temperature.celsius(327.43f).getAggregationState("Pb"));
        assertEquals("liquid", Temperature.celsius(1743.9f).getAggregationState("Pb"));
        assertEquals("gaseous", Temperature.celsius(1744).getAggregationState("Pb"));
        assertEquals("gaseous", Temperature.celsius(2000).getAggregationState("Pb"));
    }
